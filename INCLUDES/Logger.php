...
class Logger{
	...
	function error($message){
		...
		echo "\033[32m[xmlServ:" . Client::$num . "] \033[33;1m[" . $this->date() ."] \033[35;1m".$message."\033[00m\n";
	...
	function log($message){
		if($this->file)
			...
			echo "\033[32m[xmlServ:" . Client::$num . "] \033[33;1m[" . $this->date() ."]\033[1m \033[37m".$message."\033[00m\n";
	}
